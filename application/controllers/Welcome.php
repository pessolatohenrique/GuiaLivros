...
class Welcome extends CI_Controller {
	...
	public function dashboard(){
		...
		if(count($autor_mais_lido) > 0){
			...
			$this->session->set_flashdata("mensagem-erro","Nenhum livro adicionado até o momento, impedindo a criação do Dashboard!");
			redirect('/livro');
			/*
			if($inseriu){
